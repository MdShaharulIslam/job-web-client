...
const JobDetails = () => {
  ...
  const jobUrl = `https://job-junction-server-seven.vercel.app/jobs/${_id}`;
  ...
  const handleBitProject = (e) => {
    ...
    axios
      .post("https://job-junction-server-seven.vercel.app/bids", bitJobInfo)
      .then((res) => {
